...
async function applyLanguage(language) {
    ...
    if (typeof TranslationManager !== 'undefined') {
        ...
        if (language === 'en') {
            ...
            showSettingsMessage(`Translating page to ${TranslationManager.getLanguageInfo(language).nativeName}...`, 'success');
            await TranslationManager.translatePage(language, 'en');
            showSettingsMessage(`Translation complete!`, 'success');
        }
    } else {
...
function updateSettingsUI(settings) {
    ...
    if (languageDropdown) {
        languageDropdown.value = settings.language || 'en';
    }
...
function setupSettingsEventListeners() {
    ...
    // Language change listeners - check for both radio buttons and dropdown
    const languageInputs = document.querySelectorAll('input[name="language"]');
    languageInputs.forEach(input => {
        input.addEventListener('change', function() {
            if (this.checked) {
...
function saveSettings() {
    try {
        ...
        const selectedLanguage = languageDropdown ? languageDropdown.value : (languageRadio?.value || 'en');
